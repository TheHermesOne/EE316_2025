...
## RGB LEDs
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports RGB_tri_io[0]]; #IO_L22N_T3_AD7N_35 Sch=led0_b
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports RGB_tri_io[1]]; #IO_L16P_T2_35 Sch=led0_g
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports RGB_tri_io[2]]; #IO_L21P_T3_DQS_AD14P_35 Sch=led0_r
...
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports BTN_tri_i[0]]; #IO_L12P_T1_MRCC_34 Sch=ja_p[3]
set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports BTN_tri_i[1]]; #IO_L12N_T1_MRCC_34 Sch=ja_n[3]
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports BTN_tri_i[2]]; #IO_L22P_T3_34 Sch=ja_p[4]
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports BTN_tri_i[3]]; #IO_L22N_T3_34 Sch=ja_n[4]
...
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports LED_tri_o[0]]; #IO_L18P_T2_34 Sch=jb_p[3]
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports LED_tri_o[1]]; #IO_L18N_T2_34 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports LED_tri_o[2]]; #IO_L4P_T0_34 Sch=jb_p[4]
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports LED_tri_o[3]]; #IO_L4N_T0_34 Sch=jb_n[4]
...
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports DCmotor]; #IO_L21P_T3_DQS_34 Sch=ck_io[4]
...
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports Servo]; #IO_L6N_T0_VREF_34 Sch=ck_io[7]
...
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports buzzer_O]; #IO_L19N_T3_VREF_35 Sch=ck_io[13]
...
## ChipKit I2C
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports oSCL_0]; #IO_L24N_T3_34 Sch=ck_scl
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports oSDA_0]; #IO_L24P_T3_34 Sch=ck_sda
