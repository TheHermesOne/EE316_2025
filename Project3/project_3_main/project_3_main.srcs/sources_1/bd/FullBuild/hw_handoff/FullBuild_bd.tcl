...
################################################################
# This is a generated script based on design: FullBuild
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: LCD_Data_Cutter_0, and set properties
  set block_name LCD_Data_Cutter
  set block_cell_name LCD_Data_Cutter_0
  if { [catch {set LCD_Data_Cutter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $LCD_Data_Cutter_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: PWM_gen_0, and set properties
  set block_name PWM_gen
  set block_cell_name PWM_gen_0
  if { [catch {set PWM_gen_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $PWM_gen_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: i2c_user_logic_ADC_0, and set properties
  set block_name i2c_user_logic_ADC
  set block_cell_name i2c_user_logic_ADC_0
  if { [catch {set i2c_user_logic_ADC_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $i2c_user_logic_ADC_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: i2c_user_logic_LCD_0, and set properties
  set block_name i2c_user_logic_LCD
  set block_cell_name i2c_user_logic_LCD_0
  if { [catch {set i2c_user_logic_LCD_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $i2c_user_logic_LCD_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net BTN_I_0_1 [get_bd_ports Key1] [get_bd_pins btn_debounce_toggle_0/BTN_I]
  connect_bd_net -net BTN_I_0_2 [get_bd_ports Key2] [get_bd_pins btn_debounce_toggle_1/BTN_I]
  connect_bd_net -net LCD_Controller_0_LCD_DATA [get_bd_pins LCD_Controller_0/LCD_DATA] [get_bd_pins LCD_Data_Cutter_0/LCD_Data]
  connect_bd_net -net LCD_Data_Cutter_0_LCD_Nibble [get_bd_pins LCD_Data_Cutter_0/LCD_Nibble] [get_bd_pins i2c_user_logic_LCD_0/iData]
  connect_bd_net -net LCD_Data_Cutter_0_Next_data [get_bd_pins LCD_Controller_0/Next_data] [get_bd_pins LCD_Data_Cutter_0/Next_data]
  connect_bd_net -net Net [get_bd_ports scl_0] [get_bd_pins i2c_user_logic_ADC_0/scl]
  connect_bd_net -net Net1 [get_bd_ports sda_0] [get_bd_pins i2c_user_logic_ADC_0/sda]
  connect_bd_net -net Net2 [get_bd_ports scl_1] [get_bd_pins i2c_user_logic_LCD_0/scl]
  connect_bd_net -net Net3 [get_bd_ports sda_1] [get_bd_pins i2c_user_logic_LCD_0/sda]
  connect_bd_net -net Op2_0_1 [get_bd_ports Key0] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net PWM_gen_0_PWMout [get_bd_ports PWMout_0] [get_bd_pins PWM_gen_0/PWMout]
