...
--               C:/Users/uonml/Documents/GitHub/EE316_2025/Project4/keyboard/project_4.srcs/sources_1/bd/design_1/ip/design_1_ps2_keyboard_to_ascii_0_1/design_1_ps2_keyboard_to_ascii_0_1_sim_netlist.vhdl
...
entity design_1_ps2_keyboard_to_ascii_0_1_debounce is
  port (
    CLK : out STD_LOGIC;
    clear : out STD_LOGIC;
    \^clk\ : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of design_1_ps2_keyboard_to_ascii_0_1_debounce : entity is "debounce";
end design_1_ps2_keyboard_to_ascii_0_1_debounce;

architecture STRUCTURE of design_1_ps2_keyboard_to_ascii_0_1_debounce is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_ps2_keyboard_to_ascii_0_1_debounce_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_ps2_keyboard_to_ascii_0_1_debounce_0 : entity is "debounce";
end design_1_ps2_keyboard_to_ascii_0_1_debounce_0;

architecture STRUCTURE of design_1_ps2_keyboard_to_ascii_0_1_debounce_0 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_ps2_keyboard_to_ascii_0_1_ps2_keyboard is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_ps2_keyboard_to_ascii_0_1_ps2_keyboard : entity is "ps2_keyboard";
end design_1_ps2_keyboard_to_ascii_0_1_ps2_keyboard;

architecture STRUCTURE of design_1_ps2_keyboard_to_ascii_0_1_ps2_keyboard is
...
debounce_ps2_clk: entity work.design_1_ps2_keyboard_to_ascii_0_1_debounce
     port map (
      CLK => result,
      Q(0) => sync_ffs(0),
      clear => clear,
...
debounce_ps2_data: entity work.design_1_ps2_keyboard_to_ascii_0_1_debounce_0
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_ps2_keyboard_to_ascii_0_1_ps2_keyboard_to_ascii is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_ps2_keyboard_to_ascii_0_1_ps2_keyboard_to_ascii : entity is "ps2_keyboard_to_ascii";
end design_1_ps2_keyboard_to_ascii_0_1_ps2_keyboard_to_ascii;

architecture STRUCTURE of design_1_ps2_keyboard_to_ascii_0_1_ps2_keyboard_to_ascii is
  ...
  signal \ascii_code[7]_i_1_n_0\ : STD_LOGIC;
...
\ascii_code[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
      ...
      I2 => state(0),
      O => \ascii_code[7]_i_1_n_0\
    );
\ascii_code_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => \ascii_code[7]_i_1_n_0\,
      D => \ascii_reg_n_0_[0]\,
      Q => ascii_code(0),
      R => '0'
    );
...
\ascii_code_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => \ascii_code[7]_i_1_n_0\,
      D => \ascii_reg_n_0_[7]\,
...
ps2_keyboard_0: entity work.design_1_ps2_keyboard_to_ascii_0_1_ps2_keyboard
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_ps2_keyboard_to_ascii_0_1 is
  port (
    clk : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_ps2_keyboard_to_ascii_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_ps2_keyboard_to_ascii_0_1 : entity is "design_1_ps2_keyboard_to_ascii_0_1,ps2_keyboard_to_ascii,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_ps2_keyboard_to_ascii_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_ps2_keyboard_to_ascii_0_1 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of design_1_ps2_keyboard_to_ascii_0_1 : entity is "ps2_keyboard_to_ascii,Vivado 2019.1";
end design_1_ps2_keyboard_to_ascii_0_1;

architecture STRUCTURE of design_1_ps2_keyboard_to_ascii_0_1 is
...
begin
U0: entity work.design_1_ps2_keyboard_to_ascii_0_1_ps2_keyboard_to_ascii
     port map (
      D(1) => ps2_data,
      D(0) => ps2_clk,
      ascii_code(7 downto 0) => ascii_code(7 downto 0),
      ascii_new => ascii_new,
      clk => clk
    );
end STRUCTURE;
