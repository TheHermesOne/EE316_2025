...
HD_PWD='C:/Users/nathani/Documents/GitHub/EE316_2025/Project4/project4_main/project4_main.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CombineProgram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CombineProgram.tcl
