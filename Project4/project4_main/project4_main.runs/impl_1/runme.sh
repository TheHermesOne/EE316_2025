...
HD_PWD='C:/Users/nathani/Documents/GitHub/EE316_2025/Project4/project4_main/project4_main.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CombineProgram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CombineProgram.tcl -notrace
