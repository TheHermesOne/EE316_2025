...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "screen_x" -parent ${Page_0}
  ipgui::add_param $IPINST -name "screen_y" -parent ${Page_0}
...
proc update_PARAM_VALUE.screen_x { PARAM_VALUE.screen_x } {
	# Procedure called to update screen_x when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.screen_x { PARAM_VALUE.screen_x } {
	# Procedure called to validate screen_x
	return true
}

proc update_PARAM_VALUE.screen_y { PARAM_VALUE.screen_y } {
	# Procedure called to update screen_y when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.screen_y { PARAM_VALUE.screen_y } {
	# Procedure called to validate screen_y
	return true
}
...
proc update_MODELPARAM_VALUE.screen_y { MODELPARAM_VALUE.screen_y PARAM_VALUE.screen_y } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.screen_y}] ${MODELPARAM_VALUE.screen_y}
}

proc update_MODELPARAM_VALUE.screen_x { MODELPARAM_VALUE.screen_x PARAM_VALUE.screen_x } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.screen_x}] ${MODELPARAM_VALUE.screen_x}
}
